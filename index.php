...
if (isset($_POST['u_name']) && isset($_POST['u_email'])) {
    $insert_data = insertData($conn, $_POST['u_name'], $_POST['u_email'], $_POST['Phone number']);
    if ($insert_data === true) {
    ...
    <div class="wrapper">
        <div class="form">
            <form method="POST">
                ...
                <input type="number" name="Phone number" id="Phonenumber" placeholder="Enter Phone number" autocomplete="off" required>
